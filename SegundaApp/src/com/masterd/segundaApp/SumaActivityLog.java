...
public class SumaActivityLog extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		botonSuma.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				Log.d("Cambio de Estado", "SumaActivityLog está trabajando");
	...
	protected void devuelveParametros(EditText p1,EditText p2) {
		...
		Log.d("Cambio de Estado", "Se Obtiene el primer parámetro");
		String par2 = p2.getText().toString();
		Log.d("Cambio de Estado", "Se Obtiene el segundo parámetro");
		...
		finish();
		Log.d("Cambio de Estado", "SumaActivityLog ha Finalizado");
	}
}